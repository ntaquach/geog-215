...
r_birthplace_map #not only you can add a marker but you can also zoom in and out
...
leaflet() %>%
  addTiles() %>%
  setView(lng = -79.0582, lat = 35.91248, zoom = 14) %>% #center at this point on the map when you first open the map
